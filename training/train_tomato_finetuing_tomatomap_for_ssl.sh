...
train_model "yolo26_cls_finetune" "yolo26n-cls.yaml" "$YOLO26_PRETRAIN" "original"
train_model "yolo26_cls_ssl_finetune" "yolo26n-cls.yaml" "/home/agi/thesis_code/yolo26n_ssl_init.pt" "original"
